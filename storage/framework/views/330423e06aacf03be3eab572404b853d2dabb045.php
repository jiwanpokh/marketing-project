...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="<?php echo e(asset('bower_components/morris/morris.css')); ?>">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      <a href="#" class="sidebar-toggle" data-toggle="push-menu" role="button" role="button">
        ...
        <ul class="nav navbar-nav">
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <!-- User Image -->
                        <img src="<?php echo e(asset('bower_components/admin-lte/dist/img/avatar.png')); ?>" class="img-circle" alt="User Image">
                      </div>
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="bower_components/admin-lte/dist/img/sagardai.jpg" class="user-image" alt="User Image">
              <!-- hidden-xs hides the username on small devices so only the image appears. -->
              <span class="hidden-xs">Sagar Koirala</span>
            </a>
            <ul class="dropdown-menu">
              <!-- The user image in the menu -->
              <li class="user-header">
                <img src="bower_components/admin-lte/dist/img/sagardai.jpg" class="img-circle" alt="User Image">

                <p>
                  sagar Koirala - Web Developer
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <form action="<?php echo e(url('admin')); ?>" method="get" class="sidebar-form">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="<?php echo e(url('marketing')); ?>"><i class="fa glyphicon glyphicon-home"></i> <span>Dashboard</span></a></li>
        <li><a href="<?php echo e(url('project')); ?>"><i class="fa fa-book"></i> <span>Projects</span></a></li>
        <li><a href="<?php echo e(url('clients')); ?>"><i class="fa glyphicon glyphicon-user"></i> <span>Clients</span></a></li>
        <li><a href="<?php echo e(url('potentialclientdata')); ?>"><i class="fa fa-user-plus"></i> <span>Potential Clients</span></a></li>
       ...
       <!--  <li><a href="#"><i class="fa fa-microchip"></i> <span>Data Bank</span></a></li>  
        ...
        <li><a href="#"><i class="fa fa-at"></i> <span>Data Bank</span></a></li>  
        <li><a href="#"><i class="fa fa-ban"></i> <span>Purchase Request</span></a></li>  -->
     <!--    <li class="treeview">
...
<script src="bower_components/admin-lte/dist/js/adminlte.min.js"></script>
 <script src="http://ajax.googleapis.com/ajax/libs/jquery/2.0.2/jquery.min.js"></script>
  ...
  <!-- jQuery 2.0.2 -->
        <script src="<?php echo e(asset('http://ajax.googleapis.com/ajax/libs/jquery/2.0.2/jquery.min.js')); ?>"></script>
        <!-- jQuery UI 1.10.3 -->
        <script src="<?php echo e(asset('js/jquery-ui-1.10.3.min.js" type="text/javascript')); ?>"></script>
        <!-- Bootstrap -->
        <script src="<?php echo e(asset('js/bootstrap.min.js" type="text/javascript')); ?>"></script>
        <!-- Morris.js charts -->
        <script src="<?php echo e(asset('//cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js')); ?>"></script>
  ...
  <script src="<?php echo e(asset('js/jquery.dataTables1.min.js')); ?>" type="text/javascript"></script>
     ...
     <script><link rel="stylesheet" href="<?php echo e(asset('/bower_components/admin-lte/dist/js/demo.js')); ?>"></script>
