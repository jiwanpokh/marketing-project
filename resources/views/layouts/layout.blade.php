...
<head>
  ...
  <link href="{{asset('css/bootstrap.min.css" rel="stylesheet')}}" type="text/css" />
        ...
        <link href="{{asset('css/datatable/dataTables.bootstrap.min.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{asset('css/datatable/cssbootstrap.min.css')}}" rel="stylesheet" type="text/css" />
  ...
  <link rel="stylesheet" href="{{asset('/bower_components/admin-lte/dist/css/AdminLTE.min.css')}}">
   <link rel="stylesheet" href="{{asset('/bower_components/admin-lte/dist/css/img/avatar.jpg')}}">
...
<script src="bower_components/admin-lte/dist/js/adminlte.min.js"></script>
 <script src="http://ajax.googleapis.com/ajax/libs/jquery/2.0.2/jquery.min.js"></script>
  ...
  <script src="{{asset('js/jquery-3.js')}}" type="text/javascript"}}></script>
  <script src="{{asset('js/jquery.dataTables1.min.js')}}" type="text/javascript"></script>
